				...
				<div className='p-4 sm:p-6 lg:p-8 rounded-lg overflow-hidden'>
					...
					>
						<div className='h-full w-full flex flex-col justify-center items-center text-center gap-y-8'>
							<div className='font-bold text-3xl sm:text-5xl lg:text-6xl sm:max-w-xl max-w-xs text-black dark:text-white bg-secondary/60 p-4 rounded-lg flex flex-col gap-4'>
								Featured Products
								<Button
									size='lg'
